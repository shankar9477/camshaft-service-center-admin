...
public class JobcardDao 
{
	...
	//**************GET ALL RECORD******************//
	public static List<Jobcard> getAllRecords() {
		...
		{
			currentCon = ConnectionManager.getConnection();
			PreparedStatement ps = currentCon.prepareStatement("SELECT * from jobcard");
			ResultSet rs = ps.executeQuery();

			while (rs.next()) {
				
				Jobcard jobcard=new Jobcard();
				jobcard.setId(rs.getInt("id"));
				jobcard.setVehicleno(rs.getString("vehicleno"));
				jobcard.setCustomerid(rs.getString("customerid"));
				jobcard.setJobdate(rs.getString("jobdate"));
				jobcard.setMeterreading(rs.getString("meterreading"));
				jobcard.setFuel(rs.getString("fuel"));
				jobcard.setEmployeeid(rs.getString("employeeid"));
