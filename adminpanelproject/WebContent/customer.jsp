...
<body class="app sidebar-mini rtl">
	...
	<div class="app-title">
		<div>
			<h1>
				<i class="fa fa-th-list"></i> Customer Table
			</h1>
				...
				<div class="tile">
					<div class="tile-body">
						...
						<table class="table table-hover table-bordered" id="sampleTable">
							...
							<c:forEach items="${list}" var="custbean">
								<tr>
									<td>${custbean.getCustid()}</td>
									<td>${custbean.getCustname()}</td>
									<td>${custbean.getCustemail()}</td>
									<td>${custbean.getCustpassword()}</td>
									<td>${custbean.getCustaddress()}</td>
									<td>${custbean.getCustcity()}</td>
									<td>${custbean.getCuststate()}</td>
									<td>${custbean.getCustmobileno()}</td>
									<td>
										<button class="btn btn-primary btn-sm" type="button"
											onclick="window.location.href='customergeteditvalue.jsp?id=${custbean.getCustid()}'">Edit</button>
									</td>
									<td>
										<button class="btn btn-primary btn-sm" type="button"
											onclick="window.location.href='customerDelete.jsp?id=${custbean.getCustid()}'">Delete</button>
									</td>
								</tr>
							</c:forEach>
