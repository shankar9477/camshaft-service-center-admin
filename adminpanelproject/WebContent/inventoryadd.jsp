...
<body class="app sidebar-mini rtl">
	...
	<div class="app-title">
		<div>
			<h1>
				<i class="fa fa-file-text-o"></i> Inventory
			</h1>
		</div>
				...
				<section class="invoice">
					...
					<div class="row invoice-info">
						...
						<div class="col-8">
							<div class="tile"> 
								<div class="tile-body">
									<form action="inventoryservlet" method="post" role="form">
										...
										<div class="form-group">
											<label class="control-label">Inward date</label> <input
												class="form-control" type="date" name="inwarddate"
												id="inwarddate" placeholder="Enter brand name">
										</div>
										<div class="form-group">
											<label class="control-label">Out warddate</label> <input
												class="form-control" type="date" name="outwarddate"
												id="outwarddate" placeholder="Enter brand name">
										</div>
										<div class="form-group">
											<label class="control-label">Price</label> <input
												class="form-control" type="number" name="price"
												id="price" placeholder="Enter brand name">
										</div>
										<div class="form-group">
											<label class="control-label">Quantity</label> <input
												class="form-control" type="number" name="quantity"
												id="quantity" placeholder="Enter brand name">
										</div>
