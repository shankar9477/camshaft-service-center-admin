...
<body>
	...
	<section class="login-content">
		<div class="logo">
			<h1>Camshaft Service Centre</h1>
			<center>
				<h1>Admin</h1>
			</center>
		</div>
		<div class="login-box">
			<form class="login-form" action="adminloginservlet" method="post" role="form">
				<h3 class="login-head">
				...
				<div class="form-group btn-container">
					<button class="btn btn-primary btn-block" type="submit" name="submit" value="Sign In" id="demo">
